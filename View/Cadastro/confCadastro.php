...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <section class="bg-primary" id="confCadastro">
            ...
            $novoUsuario->setNome($_POST["nomeUsuario"]);
            $novoUsuario->setCpf($_POST['cpfUsuario']);
            $novoUsuario->setEndereco($_POST['enderecoUsuario']);
            $novoUsuario->setEmail($_POST['emailUsuario']);
            $novoUsuario->setSenha($_POST['senhaUsuario']);
            $novoUsuario->setCidade($_POST['cidadeUsuario']);
            $novoUsuario->setEstado($_POST['estadoUsuario']);
            $novoUsuario->setCep($_POST['cepUsuario']);
            //$novoUsuario->setTermoAceitacao($_POST['aceitacaoUsuario']);
...
//            $usuarioDAO->InserirUsuario($novoUsuario)
            ...
            <div class="col-lg-8 mx-auto text-center">
                <h2 class="section-heading text-white">Seu cadastro foi realizado com sucesso!!</h2>
                <hr class="light my-4">
                <p class="text-faded mb-4">Seu cadastro na GAMELAND foi realizado com sucesso, agora você ja pode solicitar o conserto do seu console. </p>
                <a class="btn btn-light btn-xl js-scroll-trigger" href="../../index.php">Confirmar</a>
            </div>
        </section>
