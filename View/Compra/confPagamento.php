    ...
    <body id="page-top">
        ...
        <section class="bg-primary" id="confCadastro">
            <div class="col-lg-8 mx-auto text-center">
                <h2 class="section-heading text-white">Pagamento Confirmado</h2>
                <hr class="light my-4">
                <p class="text-faded mb-4">Seu pagamento foi confirmado! <br><br> Clique abaixo para voltar à página Inicial.</p>
                <a class="btn btn-light btn-xl js-scroll-trigger" href="index.php">Voltar</a>
            </div>
        </section>
