...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <section class="bg-primary" id="confContato">
            ...
            $novoContato->setNome($_POST["nomeContato"]);
            $novoContato->setEmail($_POST['emailContato']);
            $novoContato->setAssunto($_POST['assuntoContato']);
            $novoContato->setMensagem($_POST['mensagemContato']);
            
            $contatoController->InserirContato($novoContato);
            ?>
            
            <div class="col-lg-8 mx-auto text-center">
                <h2 class="section-heading text-white">Contato realizado !!</h2>
                <hr class="light my-4">
                <p class="text-faded mb-4">Recebemos sua mensagem e logo entraremos em contato.</p>
                <a class="btn btn-light btn-xl js-scroll-trigger" href="../../index.php">Início</a>
            </div>
        </section>
